...
class CitationElement(object):
    def __init__(self, id=None, title=None, contributor=None, identifier=None, type=None, description=None, attributes=None, json_obj=None):
        ...
        if json_obj is None:
            ...
            self._title = json_obj.get(CX_CONSTANTS.CITATION_TITLE.value)
            self._contributor = json_obj.get(CX_CONSTANTS.CITATION_CONTRIBUTOR.value)
            self._identifier = json_obj.get(CX_CONSTANTS.CITATION_IDENTIFIER.value)
            self._type = json_obj.get(CX_CONSTANTS.CITATION_TYPE.value)
            self._description = json_obj.get(CX_CONSTANTS.CITATION_DESCRIPTION.value)
    ...
    def to_json(self):
        ...
        if self._contributor is not None:
            return_json[CX_CONSTANTS.CITATION_CONTRIBUTOR.value] = self._contributor

        if self._identifier is not None:
            return_json[CX_CONSTANTS.CITATION_IDENTIFIER.value] = self._identifier
