...
class TestClient(unittest.TestCase):
    ...
    def test_ndex2_put_no_json_empty_resp_code_204(self):
        with requests_mock.mock() as m:
            m.put(constants.DEFAULT_SERVER + '/hi', status_code=204)
            ndex = Ndex2()
            res = ndex.put('/hi')
    ...
    def test_ndex2_put_no_json_empty_code_200(self):
        with requests_mock.mock() as m:
            m.put(constants.DEFAULT_SERVER + '/hi',
                  status_code=200,
                  text='hehe',
                  request_headers={'Content-Type': 'application/'
                                                   'json;charset=UTF-8',
                                   'Accept': 'application/json',
                                   'User-Agent': Ndex2.USER_AGENT},
    ...
    def test_ndex2_post_with_json_and_json_resp(self):
        with requests_mock.mock() as m:
            m.post(constants.DEFAULT_SERVER + '/hi',
                   status_code=200,
                   json={'hi': 'bye'},
                   headers={'Content-Type': 'application/json'})
            ndex = Ndex2()
    ...
    def test_ndex2_delete_with_json_and_json_resp(self):
        with requests_mock.mock() as m:
            m.delete(constants.DEFAULT_SERVER + '/hi',
                     status_code=200,
                     json={'hi': 'bye'},
                     headers={'Content-Type': 'application/json'})
            ndex = Ndex2()
    ...
    def test_ndex2_get_with_json_and_json_resp(self):
        with requests_mock.mock() as m:
            m.get(constants.DEFAULT_SERVER + '/hi?x=y',
                  status_code=200,
                  json={'hi': 'bye'},
                  headers={'Content-Type': 'application/json'})
            ndex = Ndex2()
    ...
    def test_ndex2_post_multipart_with_querystring(self):
        with requests_mock.mock() as m:
            m.post(constants.DEFAULT_SERVER + '/hi?yo=1',
                   request_headers={'Connection': 'close'},
                   status_code=200)
            ndex = Ndex2()
            ndex.set_debug_mode(True)
    ...
    def test_save_new_network_cx_with_emptystatus_and_publicvisibility(self):
        with requests_mock.mock() as m:
            resurl = constants.DEFAULT_SERVER + '/network/asdf'
            m.post(constants.DEFAULT_SERVER + '/network?visibility=PUBLIC',
                   request_headers={'Connection': 'close'},
                   status_code=1,
                   text=resurl)
            ndex = Ndex2(username='bob', password='warnerbrandis')
    ...
    def test_update_cx_network_success(self):
        with requests_mock.mock() as m:
            resurl = constants.DEFAULT_SERVER + '/network/asdf'
            m.put(constants.DEFAULT_SERVER + '/network/someid',
                  request_headers={'Connection': 'close'},
                  status_code=1,
                  text=resurl)
            ndex = Ndex2(username='bob', password='warnerbrandis')
    ...
    def test_set_network_system_properties_success(self):
        ...
        with requests_mock.mock() as m:
            m.put(constants.DEFAULT_SERVER + '/network/' +
    ...
    def test_get_network_as_cx_stream_success(self):
        with requests_mock.mock() as m:
            m.get(constants.DEFAULT_SERVER + '/network/someid',
                  status_code=200,
                  json={'hi': 'bye'},
                  headers={'Content-Type': 'application/json'})
            ndex = Ndex2()
    ...
    def test_get_network_aspect_as_cx_stream_success(self):
        with requests_mock.mock() as m:
            m.get(constants.DEFAULT_SERVER + '/network/someid/aspect/sa',
                  status_code=200,
                  json={'hi': 'bye'},
                  headers={'Content-Type': 'application/json'})
            ndex = Ndex2()
    ...
    def test_get_neighborhood_as_cx_stream(self):
        with requests_mock.mock() as m:
            m.post(constants.DEFAULT_SERVER + '/search/network/someid/query',
                   status_code=200,
                   json={'hi': 'bye'},
                   request_headers={'Connection': 'close'},
                   headers={'Content-Type': 'application/json'})
    ...
    def test_get_interconnectquery_as_cx_stream(self):
        with requests_mock.mock() as m:
            m.post(constants.DEFAULT_SERVER +
                   '/search/network/someid/interconnectquery',
                   status_code=200,
                   json={'hi': 'bye'},
                   request_headers={'Connection': 'close'},
                   headers={'Content-Type': 'application/json'})
    ...
    def test_get_network_summary(self):
        with requests_mock.mock() as m:
            m.get(constants.DEFAULT_SERVER + '/network/someid/summary',
                  status_code=200,
                  json={'hi': 'bye'},
                  headers={'Content-Type': 'application/json'})
            ndex = Ndex2()
    ...
    def test_delete_networkset_success(self):
        with requests_mock.mock() as m:
            m.delete(constants.DEFAULT_SERVER + '/networkset/someid',
                     status_code=204,
                     headers={'Content-Type': 'application/json'})
            ndex = Ndex2(username='bob', password='warnerbrandis')
    ...
    def test_get_task_by_id_success(self):
        with requests_mock.mock() as m:
            m.get(constants.DEFAULT_SERVER + '/task/someid',
                  status_code=200,
                  json={'hi': 'bye'},
                  headers={'Content-Type': 'application/json'})
            ndex = Ndex2(username='bob', password='warnerbrandis')
    ...
    def test_add_networks_to_networkset(self):
        with requests_mock.mock() as m:
            m.post(constants.DEFAULT_SERVER + '/networkset/aid/members',
                  status_code=200,
                  json='',
                  headers={'Content-Type': 'application/json'})
            ndex = Ndex2(username='bob', password='warnerbrandis')
